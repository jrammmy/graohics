...
function main() 
{
  var canvas, gl, a_Position, a_Color, a_Normal;
...
function drawCylinderObjects(a_Position, gl, a_Color) 
{
  ...
  if(specular == true)
  {
    ...
    {
      tempNormHolder.push(smoothNormalHolder[i].elements[0]);
      tempNormHolder.push(smoothNormalHolder[i].elements[1]);
      tempNormHolder.push(smoothNormalHolder[i].elements[2]);
    }
  }
  else
  {
    ...
    {
      tempNormHolder.push(normalHolder[i].elements[0]);
      tempNormHolder.push(normalHolder[i].elements[1]);
      tempNormHolder.push(normalHolder[i].elements[2]);
    }
  }

  vNormalHolder = Float32Array.from(tempNormHolder);
...
function generateFlatColor(surfaceNum, vertexCt)
{
  ...
  generateFlatNormals(normalSurfaceBasePts);
...
function generateFlatNormals(normalSurfaceBasePts)
{
